...
'''
def get_data_obj_groups(h5_paths, sorted_output_folders):
    # aw 2025-02-11
    ...
    def load_three_objects(h5_path, sorted_output_folder, recording_details):
        ...
        try:
            _, well_recs, _, _ = load_recordings(h5_path, stream_select=stream_select)
        ...
        # load sorting object
        try: sort_obj = load_kilosort2_results(sorted_output_folder)
    ...
    for h5_path in h5_paths:
        ...
        recording_details = extract_recording_details(h5_path)[0] # NOTE: this works for a list of dirs or a single dir - but treats single dir as a list of a single dir
